...
export const ARUBA_STAYS = [
  ...
  { id: 'stay_riu', site: 'https://www.riu.com/', kind: 'aruba', name: 'RIU Palace Antillas', area: 'Palm Beach', country: 'Aruba', category: 'ai',
  ...
  { id: 'stay_barcelo', site: 'https://www.barcelo.com/', kind: 'aruba', name: 'Barceló Aruba', area: 'Palm Beach', country: 'Aruba', category: 'ai',
  ...
  { id: 'stay_tamarijn', site: 'https://www.tamarijnaruba.com/', kind: 'aruba', name: 'Tamarijn Aruba All Inclusive', area: 'Druif Beach', country: 'Aruba', category: 'ai',
  ...
  { id: 'stay_divi', site: 'https://www.diviaruba.com/', kind: 'aruba', name: 'Divi Aruba All Inclusive', area: 'Druif Beach', country: 'Aruba', category: 'ai', house: true,
