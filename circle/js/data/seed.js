...
export function seed(now = new Date('2026-09-05T14:20:00Z')) {
  ...
  // Sasha's Carnival-week request was declined, with the reason members read verbatim.
  {
    ...
    add({ id: uid('red'), memberId: 'mem_sasha', stayId: 'stay_ritz', kind: 'stay', checkIn: '2027-02-05', checkOut: '2027-02-08', nights: q.nights,
      ...
      decision: 'Carnival week needs seven nights at the negotiated rate and the Ritz-Carlton has none left. 14–17 February is open, and cheaper.',
  ...
  note('September to November is the quiet stretch', 'Bon dia, Circle. The island is quiet, the rates are the lowest of the year, and Aruba sits outside the hurricane belt — so these weeks carry almost no weather risk. Put your dates into any place on the list and you will see it.', '2026-08-28T09:15:00Z');
